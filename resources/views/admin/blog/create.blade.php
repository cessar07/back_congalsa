...
@section('title' , 'Congalsa - Agregar noticia')
@section('title_page' , 'Agregar noticia')
@section('body')
	    ...
	    <div class="col-lg-12 col-md-12">
	        <div class="card">
	            <div class="card-body">
	                ...
	                @endif
	                <form action="{{ url('/admin/news/') }}" method="POST" autocomplete="off" enctype="multipart/form-data">
	                	{{ csrf_field() }}
	                	...
	                	<div class="form-group">
	                		...
	                		<textarea name="content" id="mymce" cols="30" rows="10" class="form-control"></textarea>
	                	</div>
	                	<div class="row">
	                		<div class="col-lg-4">
	                			<div class="form-group">
	                		...
	                		<div class="col-lg-4">
	                			<div class="form-group">
			                		...
			                		<select name="status" id="status" class="form-control">
			                			...
			                			<option value="2">Publicar el dia</option>
			                		</select>
			                	</div>
	                		</div>
	                		<div class="col-lg-4">
	                			<div class="form-group">
	                				...
	                				<input type="text" name="date_publish" id="date_publish" class="form-control mydatepicker" placeholder="dd/mm/yyyy" disabled>
	                			</div>
	                		</div>
	                		<div class="col-lg-12">
	                			<div class="form-group">
