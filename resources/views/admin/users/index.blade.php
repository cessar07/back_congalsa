...
@section('title' , 'Congalsa - Lista de usuarios')
@section('title_page' , 'Lista de usuarios')
@section('body')
	...
	<div class="row">
		<div class="col-lg-12 col-md-12">
	        <div class="card">
	            <div class="card-body">
	                <h5 class="card-title">Usuarios registradas</h5>
							...
							<tbody>
								@foreach($u as $c)
									<tr>
										...
										<td>
											<button class="btn btn-sm {{ $c->status == 1 ? 'btn-success' : 'btn-danger' }}">
												{{ $c->status == 1 ? 'Activo' : 'Bloqueado' }}
											</button>
										</td>
										<td>
											{{ $c->points ? $c->points : 0 }} Punto(s)
										</td>
										<td>
											{{ $c->user }}
										</td>
										<td>
											<div class="btn-group">
												...
												<a href="#update_{{ $c->id }}" class="btn btn-sm {{ $c->status == 1 ? 'btn-danger' : 'btn-success' }}" data-toggle="modal">
										            ...
										            <div class="modal-content">
										                <div class="modal-header">
										                    <h4 class="modal-title" id="exampleModalLabel1">
										                    	Seguro de {{ $c->status == 1 ? 'Bloquear' : 'Activar' }} este usuario?
										                    </h4>
										                ...
										                <div class="modal-body text-center">
										                	...
										                	<div class="btn-group">
										                		<a href="{{ url('/admin/users/updateStatus/'.$c->id) }}" class="btn {{ $c->status == 1 ? 'btn-danger' : 'btn-success' }}">
										                			{{ $c->status == 1 ? 'Bloquear' : 'Activar' }}
										                		</a>
